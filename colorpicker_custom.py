"""
This is a script from the flet-contrib library, I've changed it a little to make it work with a function in its call
All the credits to the creators
Original link -> https://pypi.org/project/flet-contrib/

To make it work you need to install the library (pip install flet-contrib)
and then go to the file "color_picker.py" and change the code.
"""
import colorsys
...
class ColorPicker(ft.Column):
    #/*POR MARCO PEÑA EN FECHA 7-1-2024.*/
    def __init__(self, on_change_color_picker ,color="#000000", width=COLOR_MATRIX_WIDTH):
    #/*FIN*/
        super().__init__()
        self.tight = True
        self.width = width
